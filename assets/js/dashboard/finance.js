...
class ParentPaymentsModule {
  ...
  static updateSubmitState(form) {
    ...
    button.style.background = ready ? "#047857" : "#475569";
...
class FinanceAdminModule {
  ...
  static bind() {
    ...
    if (planButton) {
      ...
      planButton.style.cssText = "display:inline-flex;align-items:center;background:#047857;color:#ffffff;opacity:1;visibility:visible";
