...
(() => {
  ...
  const studentAccess = read("supabase", "migrations", "202608190007_match_teacher_students_by_assigned_class_or_subject.sql");
  ...
  assert.ok(studentAccess.includes("or exists"), "Teachers should see students in an assigned class or subject.");
