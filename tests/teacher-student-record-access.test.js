...
(() => {
  ...
  assert.ok(scheduling.includes('.eq("class_id", classId)'), "Scheduling must target every student in the teacher's selected class.");
  assert.ok(scheduling.includes('notificationRows'), "Scheduling must notify every student in the selected class.");
